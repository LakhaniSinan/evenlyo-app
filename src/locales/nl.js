export default {
  ...
  vendorPaymentConnectStripeFirst: 'Koppel eerst je Stripe-account.',
  ...
  'Get notified when orders are completed':
    'Krijg notificaties wanneer bestellingen zijn voltooid',
  'Notifications for new user registrations':
    'Notificaties voor nieuwe gebruikersregistraties',
  ...
  listingReviewsModalSubtitle: '{{count}} beoordelingen · gemiddeld {{rating}}',
  ...
  statusClaim: 'Claim',
  statusComplain: 'Klacht',
  statusCancelled: 'Geannuleerd',
  'Claim Details': 'Claimgegevens',
  'Claim Amount': 'Claimbedrag',
  'Claim Description': 'Claimomschrijving',
  ...
  'Please fill in all date and time fields': 'Vul alle datum- en tijdvelden in',
  ...
  validationSelectAtLeastOneCategory: 'Selecteer minimaal één categorie.',
  ...
  validationSelectAtLeastOneSubcategory: 'Selecteer minimaal één subcategorie.',
